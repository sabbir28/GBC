...
/**
 * Handles login error responses from server.
...
public class LoginError {
     ...
     *
     * @return true if login failed due to wrong email/password
     */
    public boolean isInvalidCredentials() {
        return message != null && message.toLowerCase().contains("invalid email") || message.toLowerCase().contains("password");
    }
}